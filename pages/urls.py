...
def get_dynamic_pages(base_url, lab_id, project_id):
    return [
        ...
        f"{base_url}/lab/{lab_id}/project/{project_id}/library",
        f"{base_url}/lab/{lab_id}/project/{project_id}/admin",
        f"{base_url}/lab/{lab_id}/project/{project_id}/notebooks",
        f"{base_url}/lab/{lab_id}/project/{project_id}/notebooks/member",
        f"{base_url}/lab/{lab_id}/project/{project_id}/explore/interactive/experimental/morphology?brainRegion=http%253A%252F%252Fapi.brain-map.org%252Fapi%252Fv2%252Fdata%252FStructure%252F567",
        f"{base_url}/lab/{lab_id}/project/"
        ...
        f"{base_url}/lab/{lab_id}/project/{project_id}/explore/interactive/model/synaptome?brainRegion=http%253A%252F%252Fapi.brain-map.org%252Fapi%252Fv2%252Fdata%252FStructure%252F567"
        f"{base_url}/lab/{lab_id}/project/{project_id}/build",
        f"{base_url}//lab/{lab_id}/project/{project_id}/build/me-model/new",
        f"{base_url}/lab/{lab_id}/project/{project_id}/build/synaptome/new",
        f"{base_url}/lab/{lab_id}/project/{project_id}/simulate",
    ]
